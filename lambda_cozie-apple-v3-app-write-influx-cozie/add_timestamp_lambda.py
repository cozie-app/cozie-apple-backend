...
def add_timestamp_lambda(payload, timestamp_lambda):
    ...
    for key in list(payload["fields"].keys()):
        ...
        if key in lambda_fields:
            ...
            #print(f"payload['fields']['{key}']:",        payload["fields"][f"{key}"], end="\r")
            #print(f"payload['fields']['{key}_lambda']:", payload["fields"][f"{key}_lambda"], end="\r")
            #print(f"payload['fields']['{key}_trigger']:", payload["fields"][f"{key}_trigger"], end="\r")
        #else: 
            #print("x_lambda value omitted", end="\r")
